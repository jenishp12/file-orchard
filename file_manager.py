...
class Tree:
    ...
    def copy_file(self, file_name, target_folder_name, node=None):
        ...
        if node:
            if node.name == target_folder_name:
                # Make a copy of the file into the same folder
                node.children.append(File(file_name))
                return True
            elif node.is_folder:
                for child in node.children:
...
class TreedisplayGUI:
    def __init__(self, file_manager):
        ...
        self.root.geometry("500x200")  # size of widget
        self.root.attributes('-topmost', True)  # setting windows as topmost
    ...
    while True:
        ...
        if option == "1":
            while True:
                ...
                elif foldername.upper() in ['CON', 'PRN', 'AUX', 'NUL', 'COM1', 'COM2', 'COM3', 'COM4', 'COM5', 'COM6', 'COM7', 'COM8', 'COM9', 'LPT1', 'LPT2', 'LPT3', 'LPT4', 'LPT5', 'LPT6', 'LPT7', 'LPT8', 'LPT9']:
            ...
            while True:
                ...
                if not valid_name(file_name):
                ...
                elif file_name.upper() in ['CON', 'PRN', 'AUX', 'NUL', 'COM1', 'COM2', 'COM3', 'COM4', 'COM5', 'COM6', 'COM7', 'COM8', 'COM9', 'LPT1', 'LPT2', 'LPT3', 'LPT4', 'LPT5', 'LPT6', 'LPT7', 'LPT8', 'LPT9']:
                    ...
                    folder = find_folder(file_manager.root, folder_name)
                    if folder:
